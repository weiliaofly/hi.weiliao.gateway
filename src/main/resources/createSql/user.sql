...
CREATE TABLE USER_AUTH (
  ...
  QQ_OPENID			 VARCHAR(200)    NULL DEFAULT '' COMMENT 'QQ的openid',
  SOURCE             VARCHAR(10)          DEFAULT 'UNKNOW' COMMENT '用户来源',
...
CREATE TABLE INVITE_HISTORY (
  ...
  ADD_COIN           DECIMAL(20,0)   NOT NULL DEFAULT 0 COMMENT '增加金币数',
